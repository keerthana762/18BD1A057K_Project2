...
async function identify_user(agent)
{
  ...
  const snap = await client.db("test").collection("usersinfo").findOne({acct_num: acct_num});
...
function report_issue(agent)
{
  ...
  var issue_vals={1:"Internet Down",3:"Slow Internet",2:"Buffering problem",4:"No connectivity"};
  ...
  "richContent": [
    [
      ...
      },
      {
        "type": "list",
        "title": "Slow Internet",
        "subtitle": "Press '3' Slow Internet",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
      ...
      },
	  {
        ...
        "subtitle": "Press '2' for Buffering problem",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
